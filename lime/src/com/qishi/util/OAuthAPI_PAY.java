...
//    public static final String DOMAIN =ServerConfig.getBaseUrl();
    ...
    public static String OAuthIfNesscary(HttpServletRequest request,
        ...
        if (isValidCode) {
                ...
                JSONObject obj = OAuthAPI_PAY.getAccessToken(ServerConfig.getAPP_ID(),ServerConfig.getAPP_SECRET(), code);
                System.out.println(ServerConfig.getAPP_ID()+"----"+ServerConfig.getAPP_SECRET());
