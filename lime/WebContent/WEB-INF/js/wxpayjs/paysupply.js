...
//辅助函数
            ...
            function getPackage()
            {
            	...
            	var openidpay = document.form1.openidpay.value;//配货时间段
            	var paramurladd ="?riqi="+riqi+"&shijian="+shijian+"&openidpay="+openidpay;
                var banktype = "WX";
                var body = document.form1.body.value;//商品名称信息，这里由测试网页填入。
                var fee_type = "1";//费用类型，这里1为默认的人民币
                var input_charset = "GBK";//字符集，这里将统一使用GBK
                var notify_url = "http://weixin.yijia360.com/lime/settle/success"+paramurladd;//支付成功后将通知该地址
